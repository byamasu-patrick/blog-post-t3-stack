...
import bg from '../../public/curved14.jpg'
import Link from 'next/link';
import SignInNav from '../components/login-nav';
                  ...
                  <div className="flex flex-wrap mt-0 -mx-3">
                    <div className="flex flex-col w-full max-w-full px-3 mx-auto md:flex-0 shrink-0 md:w-6/12 lg:w-5/12 xl:w-4/12">
                      <div className="relative flex flex-col min-w-0 mt-32 break-words bg-transparent border-0 shadow-none rounded-2xl bg-clip-border">
                        ...
                        <div className="flex flex-wrap -mx-3 px-8">
                          ...
                          <div className="w-4/12 max-w-full px-1 flex-0">
                            <a className="inline-block w-full px-6 mb-4 font-bold text-center text-gray-200 uppercase align-middle transition-all bg-transparent border border-gray-200 border-solid rounded-lg shadow-none cursor-pointer hover:scale-102 leading-pro text-xs ease-soft-in tracking-tight-soft bg-150 bg-x-25 hover:bg-transparent hover:opacity-75" href="javascript:;">
                              <svg width="24px" height="32px" viewBox="0 0 64 64" version="1.1" xmlns="http://www.w3.org/2000/svg">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                          ...
                          <div className="w-4/12 max-w-full px-1 mr-auto flex-0">
                            <Link 
                              onClick={() => signIn("google")}
                              className="inline-block w-full px-6 mb-4 font-bold text-center text-gray-200 uppercase align-middle transition-all bg-transparent border border-gray-200 border-solid rounded-lg shadow-none cursor-pointer hover:scale-102 leading-pro text-xs ease-soft-in tracking-tight-soft bg-150 bg-x-25 hover:bg-transparent hover:opacity-75" href="javascript:;">
                              <svg width="24px" height="32px" viewBox="0 0 64 64" version="1.1" xmlns="http://www.w3.org/2000/svg">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        ...
                        <div className="px-6 pb-0 mb-0 bg-transparent border-b-0 rounded-t-2xl">
                          <p className="mb-0 leading-normal text-sm">Enter your email and password to sign in</p>
                        </div>
                        <div className="flex-auto p-6">
                          <form role="form">
                            ...
                            <div className="min-h-6 mb-0.5 block pl-12">
                              ...
                              <label className="mb-2 ml-1 font-normal cursor-pointer select-none text-sm text-slate-700">Remember me</label>
                            </div>
                        ...
                        <div className="p-6 px-1 pt-0 text-center bg-transparent border-t-0 border-t-solid rounded-b-2xl lg:px-2">
                          <p className="mx-auto mb-6 leading-normal text-sm">
                            ...
                            <Link href="signup"  className="relative z-10 font-semibold text-transparent bg-gradient-to-tl from-gray-600 to-slate-700 bg-clip-text"> Sign Up</Link>
                          </p>
                        </div>
                      </div>                    
                    </div>
                    ...
                    <div className="w-full max-w-full px-3 lg:flex-0 shrink-0 md:w-6/12">
                      <div className="absolute top-0 hidden w-3/5 h-full -mr-32 overflow-hidden -skew-x-10 -right-40 rounded-bl-xl md:block">
                        <div className="absolute inset-x-0 top-0 z-0 h-full -ml-16 bg-cover skew-x-10"style={
                          divStyle
                        }></div>
                      </div>
                    </div>
